...
Public Module Helper
    ...
    Public mosleyMod As String = "inm_mas_active"

    Public veh, tra As Vehicle
    Public bike1, bike2, bike3, bike4, car1, car2, car3, car4, car5, car6, car7, car8, car9, car10, car11 As Vehicle
    Public bPos1 As New Vector3(-44.32722, -1667.96741, 28.9956436), bPos2 As New Vector3(-44.21046, -1666.50562, 28.9477348), bPos3 As New Vector3(-43.06911, -1665.19141, 28.8280983),
        bPos4 As New Vector3(-42.32024, -1664.13831, 28.9624214), cPos1 As New Vector3(-37.84413, -1660.94958, 29.0238323), cPos2 As New Vector3(-35.61622, -1658.23523, 28.8608456),
        cPos3 As New Vector3(-33.4662857, -1655.48657, 28.9243488), cPos4 As New Vector3(-31.58375, -1652.84619, 28.871191), cPos5 As New Vector3(-24.82662, -1645.02344, 28.9541),
        cPos6 As New Vector3(-22.80617, -1642.54871, 28.7953472), cPos7 As New Vector3(-19.8982735, -1642.803, 29.0800228), cPos8 As New Vector3(-19.3836117, -1656.12292, 28.8836269),
        cPos9 As New Vector3(-10.7235308, -1676.69067, 30.222374), cPos10 As New Vector3(-16.9800358, -1653.8728, 28.8594837), cPos11 As New Vector3(-26.6400089, -1658.14563, 29.1246986)
    Public bRot1 As New Vector3(0.591591537, -10.61885, -66.76514), bRot2 As New Vector3(-1.5295068, -8.345043, -95.86776), bRot3 As New Vector3(0.202504, -8.065519, -113.332481),
        bRot4 As New Vector3(0.89253515, -12.5469685, -115.357719), cRot1 As New Vector3(-0.0382797346, -0.06428638, -97.5849838), cRot2 As New Vector3(0.0228415318, -0.00732754031, -94.9011154),
        cRot3 As New Vector3(0.060910143, 0.128137425, -95.89636), cRot4 As New Vector3(0.05856648, 0.06917845, -98.52988), cRot5 As New Vector3(0.100864068, 0.186999545, -160.188171),
        cRot6 As New Vector3(0.0254601277, 0.0978482738, -163.775253), cRot7 As New Vector3(0.0290455744, -0.0412543342, -167.437363), cRot8 As New Vector3(0.00146629941, 0.0336471461, 13.6329308),
        cRot9 As New Vector3(0.52212, -0.009268484, 23.593153), cRot10 As New Vector3(-0.07703708, 0.06743768, 9.938053), cRot11 As New Vector3(0.145598441, 0.0276625138, -40.13631)

    Public ply As Ped
    Public mosleyIntID As Integer
    Public isExiting As Boolean = False
    Public lastVehMemory As Memory
    Public mosleyBlip As Blip
    Public mosleyPed As Ped
    Public isCutscene As Boolean = False
    Public scriptCam As Camera
    ...
    Public fpcKey As GTA.Control = Control.NextCamera
    Public zoutKey As GTA.Control = Control.ParachuteBrakeRight
    Public zinKey As GTA.Control = Control.ParachuteBrakeLeft
    Public roofKey As GTA.Control = GTA.Control.VehicleRoof
    Public doorKey As GTA.Control = GTA.Control.Jump
    ...
    Public parkBike1 As String = "zombiea"
    Public parkBike2 As String = "nightblade"
    Public parkBike3 As String = "defiler"
    Public parkBike4 As String = "bf400"
    Public parkCar1 As String = "kanjo"
    Public parkCar2 As String = "impaler"
    Public parkCar3 As String = "zion3"
    Public parkCar4 As String = "jester3"
    Public parkCar5 As String = "gp1"
    Public parkCar6 As String = "gauntlet4"
    Public parkCar7 As String = "asbo"
    Public parkCar8 As String = "jugular"
    Public parkCar9 As String = "cog55"
    Public parkCar10 As String = "vstr"
    ...
    Public BtnZoom, BtnZoomOut, BtnFirstPerson, BtnDoor, BtnRoof As InstructionalButton
    Public _menuPool, _menuPoolSR As MenuPool
    ...
    'Showroom
    Public hiddenSave As ScriptSettings = ScriptSettings.Load("scripts\MosleyAutoService\database.ini")

    Public SelectedVehicle As String, PlayerCash, VehiclePrice As Integer, VehPreview As Vehicle, PdmBlip As Blip
    Public Price As Integer = 0, TestDrive As Integer = 1, VehicleName As String = Nothing
    Public HideHud As Boolean = False, DrawSpotLight As Boolean = False, ShowVehicleName As Boolean = False
    Public srDoor As Vector3 = New Vector3(-37.67852, -1671.333, 29.48229), PlayerLastPos As Vector3
    Public VehPreviewPos As Vector3 = New Vector3(-20.84555, -1650.121, 28.90441)
    Public CameraPos As Vector3 = New Vector3(-25.73564, -1650.511, 29.85592)
    Public CameraRot As Vector3 = New Vector3(-11.48978, -0.1261616, -85.2147)
    Public PlayerHeading As Single = 314.8361
    Public srDoorDist As Single = 0F
    Public cameraSR As WorkshopCamera = New WorkshopCamera
    Public lastSRVehMemory As Memory
    Public TaskScriptStatus As Integer = -1
    Public pdmPed As Ped
    ...
    Public Function IsUpgradeModExist(vehDispName As String) As Boolean
        ...
        Dim config As ScriptSettings = ScriptSettings.Load("scripts\MosleyAutoService\config.ini")
        Dim v As String = config.GetValue(Of String)("UPGRADE", vehDispName.ToString.ToUpper & "_MODEL", Nothing)
        If v = Nothing Then
            result = False
        Else
            result = True
    ...
    Public Function GetUpgradeModVehicleInfo(vehDispName As String) As Tuple(Of String, Integer)
        Dim config As ScriptSettings = ScriptSettings.Load("scripts\MosleyAutoService\config.ini")
        Dim newModel As String = config.GetValue(Of String)("UPGRADE", vehDispName.ToString.ToUpper & "_MODEL", Nothing)
        Dim newPrice As Integer = config.GetValue(Of Integer)("UPGRADE", vehDispName.ToString.ToUpper & "_PRICE", 0)
    ...
    Public Sub PlaySpeech(speechName As String)
        ...
        Native.Function.Call(Hash._PLAY_AMBIENT_SPEECH_WITH_VOICE, mosleyPed, speechName, "BENNY", "SPEECH_PARAMS_FORCE_SHOUTED", 0)
    End Sub

    <Extension()>
    Public Sub SetLivery2(veh As Vehicle, liv As Integer)
        Native.Function.Call(CType(&HA6D3A8750DC73270UL, Hash), veh.Handle, liv)
    End Sub

    <Extension()>
    Public Function GetLivery2(veh As Vehicle) As Integer
        Return Native.Function.Call(Of Integer)(CType(&H60190048C0764A26UL, Hash), veh.Handle)
    End Function

    <Extension()>
    Public Function Livery2Count(veh As Vehicle) As Integer
        Return Native.Function.Call(Of Integer)(CType(&H5ECB40269053C0D4UL, Hash), veh.Handle)
    End Function
    ...
    Public Sub LoadSettings()
        ...
        zoutKey = config.GetValue(Of GTA.Control)("CONTROLS", "ZOOMOUT", GTA.Control.ParachuteBrakeRight)
        zinKey = config.GetValue(Of GTA.Control)("CONTROLS", "ZOOMIN", GTA.Control.ParachuteBrakeLeft)
        roofKey = config.GetValue(Of GTA.Control)("CONTROLS", "ROOF", GTA.Control.VehicleRoof)
        doorKey = config.GetValue(Of GTA.Control)("CONTROLS", "DOOR", GTA.Control.Jump)
        ...
        optLastVehHash = hiddenSave.GetValue(Of Integer)("SAVE", "LASTVEHHASH", -2022483795)
        optLastVehName = hiddenSave.GetValue(Of String)("SAVE", "LASTVEHNAME", "Pfister Comet Retro Custom")

        parkBike1 = config.GetValue(Of String)("PARKING", "BIKE1", "zombiea")
        parkBike2 = config.GetValue(Of String)("PARKING", "BIKE2", "nightblade")
        parkBike3 = config.GetValue(Of String)("PARKING", "BIKE3", "defiler")
        parkBike4 = config.GetValue(Of String)("PARKING", "BIKE4", "bf400")
        parkCar1 = config.GetValue(Of String)("PARKING", "CAR1", "kanjo")
        parkCar2 = config.GetValue(Of String)("PARKING", "CAR2", "impaler")
        parkCar3 = config.GetValue(Of String)("PARKING", "CAR3", "zion3")
        parkCar4 = config.GetValue(Of String)("PARKING", "CAR4", "jester3")
        parkCar5 = config.GetValue(Of String)("PARKING", "CAR5", "gp1")
        parkCar6 = config.GetValue(Of String)("PARKING", "CAR6", "gauntlet4")
        parkCar7 = config.GetValue(Of String)("PARKING", "CAR7", "asbo")
        parkCar8 = config.GetValue(Of String)("PARKING", "CAR8", "jugular")
        parkCar9 = config.GetValue(Of String)("PARKING", "CAR9", "cog55")
        parkCar10 = config.GetValue(Of String)("PARKING", "CAR10", "vstr")
        parkCar11 = config.GetValue(Of String)("PARKING", "CAR11", "everon")
    End Sub

    Public Sub CreateBlip()
        mosleyBlip = World.CreateBlip(New Vector3(-11.66313, -1667.733, 28.90435))
        mosleyBlip.Sprite = (BlipSprite.DollarSignSquared Or BlipSprite.ArrowDownOutlined)
        mosleyBlip.Color = BlipColor.GreyLight
        mosleyBlip.IsShortRange = True
        mosleyBlip.Name = "Mosley Auto Service"
    End Sub
    ...
    Public Sub PlayEnterCutScene()
        Try
            ...
            isExiting = True
            isCutscene = True
            If mosleyPed = Nothing Then
                mosleyPed = World.CreatePed(PedHash.WareMechMale01, New Vector3(-6.137212, -1662.242, 29.47964), 128.7046)
            Else
                mosleyPed.Delete()
                mosleyPed = World.CreatePed(PedHash.WareMechMale01, New Vector3(-6.137212, -1662.242, 29.47964), 128.7046)
            End If
            mosleyPed.Task.LookAt(veh)
            mosleyPed.AlwaysKeepTask = True
            veh.Position = New Vector3(-21.9468, -1677.92, 28.90046)
            veh.Heading = 319.9388
            Script.Wait(1000)
            Game.FadeScreenIn(1000)
            scriptCam = World.CreateCamera(New Vector3(-16.23257, -1663.606, 30.29995), Vector3.Zero, GameplayCamera.FieldOfView)
            'Dim interpCam As Camera = World.CreateCamera(New Vector3(-16.23257, -1663.606, 30.29995), Vector3.Zero, GameplayCamera.FieldOfView)
            ...
            ply.Task.DriveTo(veh, New Vector3(-11.66313, -1667.733, 28.90435), 0.1, 3)
            Script.Wait(2000)
    ...
    Public Sub PlayExitCutScene()
        Try
            ...
            scriptCam = World.CreateCamera(New Vector3(11.41584, -1676.853, 32.66526), Vector3.Zero, GameplayCamera.FieldOfView)
            Dim interpCam As Camera = World.CreateCamera(New Vector3(11.54931, -1682.427, 30.39337), Vector3.Zero, GameplayCamera.FieldOfView)
            World.RenderingCamera = scriptCam
            scriptCam.PointAt(veh)
            scriptCam.InterpTo(interpCam, 5000, True, True)
            World.RenderingCamera = interpCam
            ...
            World.RenderingCamera = Nothing
            ply.Task.ClearAll()
            If Not veh.Position.DistanceTo2D(New Vector3(0.2286473, -1673.708, 28.90418)) <= 4.0F Then
                Game.FadeScreenOut(1000)
                Script.Wait(1000)
                veh.Position = New Vector3(0.2286473, -1673.708, 28.90418)
                veh.Heading = 202.2443
                Script.Wait(1000)
                veh.Repair()
                Game.FadeScreenIn(1000)
            End If
    ...
    Public Function GetLangEntry(Lang As String) As String
        Dim result As String = ReadCfgValue(Lang, ".\scripts\MosleyAutoService\Languages\" & Game.Language.ToString & ".cfg")
    ...
    Public Sub UpdateVehPreview()
        lastSRVehMemory = New Memory() With {
    ...
    Public Sub SpawnPed(pedhash As PedHash, ByRef ped As Ped, pos As Vector3, head As Single)
        If ped = Nothing Then
            ped = World.CreatePed(pedhash, pos, head)
    ...
    Public Sub DeletePed(ByRef ped As Ped)
    ...
    Public Sub SpawnVehicle(model As String, ByRef veh As Vehicle, pos As Vector3, ByRef rot As Vector3)
        Try
            If veh = Nothing Then
                Dim newPos As New Vector3(pos.X, pos.Y, pos.Z - 1.0F)
                veh = World.CreateVehicle(model, newPos, rot.Z)
                veh.IsPersistent = True
                veh.HasAlarm = True
                veh.LockStatus = VehicleLockStatus.CanBeBrokenInto
                veh.SetBool(mosleyMod, True)
            End If
        Catch
            Exit Sub
        End Try
    ...
    Public Sub DeleteVehicle(ByRef veh As Vehicle)
        If Not veh = Nothing Then
            If veh.GetBool(mosleyMod) Then veh.Delete()
            veh = Nothing
        End If
    End Sub
